...
class AttendanceRecapReportWizard(models.TransientModel):
    ...
    def get_report(self):
        ...
        return self.env.ref('individual_customer_report.recap_report').report_action(self, data=data)
...
class ReportAttendanceRecap(models.AbstractModel):
    ...
    _name = 'report.individual_customer_report.attendance_recap_report_view'
